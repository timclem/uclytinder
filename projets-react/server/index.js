...
app.get('/creatsignIn', (req, res) => {
    let sql = 'CREATE TABLE signIn(id int AUTO_INCREMENT, name TEXT(255) NOT NULL, age INT NOT NULL, sex TEXT(255) NOT NULL, mail TEXT(255) NOT NULL, password TEXT(255) NOT NULL, PRIMARY KEY(id))';
